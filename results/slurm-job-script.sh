...
#
#SBATCH --job-name=tr_overlap_1000
#SBATCH --output=tr_overlap_1000.%j.%N.out
...
#srun Rscript -e "source('/cfs/earth/scratch/delucmat/swissrepeat/compute_tr_all_overlap_DEBUG.R')"
srun Rscript /cfs/earth/scratch/delucmat/swissrepeat/compute_tr_all_overlap.R
