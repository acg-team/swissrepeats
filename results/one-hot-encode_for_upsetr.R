...
foreach(Prot=iter(overlap_by_protein$ID), .combine = 'rbind',
...
print("Save data")
print("###############")
write.csv(listinputAA, file = paste0(local_base_path, "data/listinputAA_2.csv"))
print(paste0("AA one-hot-encoding saved in: ", local_base_path, "data/listinputAA_2.csv"))
