...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/TR_scetch/TR_classification_scetch.png}
\end{center}
...
%TODO remove the 55% and rewrite
%TR effects on health (with footnotes)
%Proteins containing TRs have enhanced binding properties \cite{Li2003} and are known to have associations with immunity related functions \cite{Usdin2008, Madsen2008} and diseases such as ALS\footnote{amyotrophic lateral sclerosis}, DM\footnote{myotonic dystrophy}, DRPLA\footnote{dentatorubral-pallidoluysian atrophy}, frontotemporal dementia, FXS\footnote{fragile X syndrome}, FXTAS\footnote{fragile X tremor-ataxia syndrome}, Huntington disease, SBMA\footnote{spinobulbar muscular atrophy} and SCA\footnote{spinocerebellar ataxia} which are all caused through tandem repeat disorders (TRD) \cite{Hannan2018}. \\
%TR effects on health (no footnotes)
...
%TODO with or without numbers? numbers are already given in introduction and methods again.
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig1.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/Mean_Prot_length_vs_Frac_TR.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig2a-2.png}
\end{center}
...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=0.75\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig2a_combined.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig5a.png}
\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig2b.png}
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig2b_simple.png}
%\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig3a_all_renormalized.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/AA_ratio_TR_vs_background.png}
\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig4a.png}
%\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig5c.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig5b.png}
\end{center}
...
%Figure \ref{venn} 9.1\% of the overall amount of protein sequences from SwissProt can be found in TR-regions, 12.9\% in intrinsic disordered regions and 2.5\% in both of them.
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/TR_disorder_overlap_venndiagram_perc.png}
\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/upsetR_all.png}
%\end{center}
%\caption{Of all amino acids in TRs, a small part overlaps with disordered regions. The most amino acids from this overlap fall in disordered regions which have a part tandemly repeated.}
%\label{upsetr}
%\end{figure}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/TR_disorder_overlap_overall_detail.png}
\end{center}
...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=0.9\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/PFAM_location_all.png}
\end{center}
...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=0.75\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/virus_virushost_cake_all.png}
\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/percentage_of_disordered_repeats.png}
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/repeats_disorderperc_vs_length.png}
%\end{center}
...
\begin{figure*}[h]
\begin{center}
\includegraphics[width=0.75\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/manuscript_NAR/figures_other_recourses/swissprotentries.png}
\end{center}
\caption{Summary of the growth of UniProtKB/Swiss-Prot protein knowledgebase. The last protein census dates back to the year 1999 \cite{Marcotte1999}. Since then, the entries in the UniProtKB/Swiss-Prot protein knowledgebase are grown more than seven fold. Figure from release $2018\_09$ statistics 	\url{https://web.expasy.org/docs/relnotes/relstat.html}, retrieved 2018/10/17.}
\label{sup:figSwissProtStats}
\end{figure*}
...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=0.75\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/TR_scetch/overlap_scetch.png}
\end{center}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/TR_distribution_unit_numbers.png}
  \caption{Distribution of TRs by TR size.}
  \label{sup:figTR_distribution_unit_number}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/TR_distribution_unit_length.png}
...
\begin{figure*}[ht]
\begin{center}
\includegraphics[width=0.75\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/TRtypes_distribution_in_prot_with_more_4TRs.png}
\end{center}
...
\begin{figure*}[ht]
\begin{center}
\includegraphics[width=0.75\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/Perc_TRs_all_sp_prots.png}
\end{center}
...
\begin{figure*}[h]
\begin{center}
\includegraphics[width=0.75\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig2a-3.png}
\end{center}
...
\begin{figure*}[h]
\begin{center}
\includegraphics[width=0.75\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig2a-4.png}
\end{center}
...
\begin{figure*}[h]
\begin{center}
\includegraphics[width=0.75\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig2a-5.png}
\end{center}
...
\begin{figure*}[h]
\begin{center}
\includegraphics[width=0.75\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig2a-6.png}
\end{center}
...
%\begin{subfigure}{.5\textwidth}
%  \centering
%  \includegraphics[width=0.9\linewidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig3a_all_renormalized.png}
%  \caption{Relative positions of TR within all proteins.}
%  \label{figTR_position_all}
%\end{subfigure}%
%\begin{subfigure}{.5\textwidth}
%  \centering
%  \includegraphics[width=0.9\linewidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig3a_Superkingdoms_renormalized.png}
...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=0.75\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig3a_Superkingdoms_renormalized.png}
\end{center}
\caption{Density plots for the relative positions of TRs within proteins for four Superkindoms. The relative position referes with 0 to the N-terminus and with 1 to the C-terminus of a protein. Colours indicate repeat unit lengths. Interestingly, short TRs are biased towards the flanks of the protein. In particular for Eukaryotes, there is a clear correlation between TR unit length and location bias to the protein flanks. For Eukaryotes, tandem repeats are particularly prevalent in the N-terminal protein flank. Homorepeats in Archaea and, to a lesser degree, in Bacteria show a strong bias to the C-terminal protein flank. }
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig3b_all_renormalized.png}
\end{center}
...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=0.75\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/AA_ratio_facet.png}
\end{center}
...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=0.75\textwidth]{/home/matteo/polybox/MSc_ACLS/swissrepeat/paper/figures/fig5a.png}
\end{center}
