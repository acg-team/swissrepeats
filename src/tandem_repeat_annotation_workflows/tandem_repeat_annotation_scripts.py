    ...
    for iS_pyfaidx in l_sequence:
        ...
        for i, iTR in enumerate(iS.get_repeatlist(DE_NOVO_ALL_TAG).repeats):
            ...
            if denovo_refined_rl and denovo_refined_rl.repeats:
                ...
                # Alternatively, in future, if new and old do not overlap, you may want to reannotate with the cpHMM,
                # however only on a sequence subset. This may be better especially for micro TRs, (however this was
                # hardly necessary for domain TRs.)
